...
import { Box, Text, HStack, Alert, Button, Link, AlertIcon, AlertTitle, AlertDescription } from '@chakra-ui/react'
...
export default function Thankyou() {
  ...
  return (
    <Box bg='white' mx='auto' mt={{base: '30px', d: 0}} w={{base: '280px', sm: '347px', d: '756px'}} py={{base: '40px', d: '70px'}} boxShadow={'0 10px 30px rgba(0,0,0,.26)'}>
      ...
      <Box maxW='570px' mx='auto' mt='40px' p={{base: '20px', d: 0}} >
        <Text
          ...
          fontWeight='bold'
          fontFamily='prelo'
          fontSize={{base: '36px', sm: '42px', d: '60px' }}
          lineHeight={{base: '40px', sm: '50px', d:'71px'}}
        >
          Thank you for
          <Box as='span' display='block'>entering!</Box>
        </Text>
